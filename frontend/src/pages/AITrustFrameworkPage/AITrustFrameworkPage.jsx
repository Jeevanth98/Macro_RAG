...
import { ShieldCheck, Search, Eye, ClipboardCheck, BarChart2, Activity, Users, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="trust-page">
      ...
      <div className="trust-framework">
        ...
        <div className="trust-layers-grid">
          {/* Layer 1 */}
        ...
        {/* Responsible AI Statement Notice Panel */}
